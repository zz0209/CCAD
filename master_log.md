...
## FINAL_THREE_R20 START

Written UTC: 2026-09-09T07:04:31Z. Verifiable start event: 2026-09-09T07:04:31Z. R19 completed and synchronized commit16947db43e17d61192b3778b95090edfb6f6f74f equals origin/main; its18-page completed PDF and all original results are preserved. Reason for this unit: the R19 selector is only0.34pp above a strong direct-trial baseline, and its native candidate/source ceiling remains far below full/raw. Increasing more of the same shallow fits would not address this gap. We will change source and native candidate fitting to the actual finite continuation: source groups optimize original donor-label full-vocabulary CE, and target groups optimize full-vocabulary source KL, with fixed64 deployment supports after a relaxed projected-Adam search. Compare raw rank1 DAS-style QR with original CE and explicitly recorded information/update budgets. These are reused optimization tools, not claims of a new algorithm.

Planned independent progress: train a second five-seed initialization cohort per objective under the identical16M-token GPT2 schedule, broaden the original CausalGym task set, add strong matching/semantic/direct-trial comparisons and hierarchical seed/task/prompt analysis, then update the unique main manuscript with the actual positive/negative result. Six task families reserved for method-generalization and the entire official test remain unused by outcomes. R20 is one comprehensive research unit; R21 remains the final frozen-confirmation/delivery unit and no extra round is created. Prospective budget in R20_BUDGET.json: finite pilot guard3600s, cohort expected1900s from measured R19 with5400s guard, wider task stage up to3600s; exact actual costs will replace estimates. Existing GPU/CPU/storage only, no paid purchase. Resource wrapper uses the original GPU lease and leaves other projects untouched. Effective active-work and wait times are not independently instrumented; record actual run clocks rather than manufacture them.


## FINAL_THREE_R20 PROGRESS — finite-response pilot and independent cohort

Written UTC: 2026-09-09T07:08:22Z. The finite native pilot completed at2026-09-09T07:07:01.966494Z:114.9051551s wall,94.53125s process CPU,6528 held result rows, contract PASS. Across the same six development queries, source IIA increases from46.32% to50.49%; source-endpoint selected IIA from41.42% to45.59%. The stronger direct smooth-margin selector is46.32%, above the endpoint predictor. The target candidate family also adds a true finite-KL group and no-op, so the total improvement does not isolate source fitting from candidate inventory. No claim of operation-aware selector superiority follows. Detailed actual source and target loss traces, supports and raw-DAS reference are retained. This is a meaningful actual source/candidate improvement opportunity to broaden, not a reason to remove direct trials. Launch the independently initialized11–15 cohort for both objectives with the same16M natural stream and hyperparameters; predicted about1900s from R19, guard5400s, no new paid resource. During training, expand baseline adapters, derive dependence-aware decision comparisons and integrate methods/material into the manuscript. Source files for R19 remain immutable snapshots; current differentiable adapter only affects R20 and later.


## FINAL_THREE_R20 PROGRESS — stronger natural baselines

Written UTC: 2026-09-09T07:17:11Z. During the independent-cohort GPU run, prepare complete8192-feature Pearson/Hungarian assignments for all ten objective/edge combinations using retained natural codes. This replaces the restricted source-support assignment as the strongest assignment baseline, while preserving both. Dense matrix peak expected about2GB and fourCPUthreads; cpu-heavy lease is independent of gpu-0, and no duplicate model/cache download is needed. Prospective limit2400s with per-map preservation; actual throughput will be logged before scaling to further families. Original feature-level SemanticOT recipe and source CausalGym training/evaluation code are being inspected for bounded reuse, rather than relabeling aggregate-group scores as full systems.


## FINAL_THREE_R20 PROGRESS / CORRECTION

Written UTC: 2026-09-09T07:28:37Z. Event times: complete dictionary PW run 2026-09-09T07:17:11Z through2026-09-09T07:18:14.961359Z, per raw progress. Ten exact8192-by8192 Hungarian maps finished in63.68 seconds, TopK PW-MCC0.6054–0.6086, Matryoshka0.4546–0.4582; inactive reference features stay included. The numerical run passed but contract validation detected a missing audit_opened config flag. Its original files are in metadata_correction, with a current truthful false flag and config hash repair; no map, output or scientific claim was recomputed.

Finite pilot analysis identifies a larger problem: rank1 raw DAS-style meanIIA86.76% versus source-native50.49%, while direct finite margin46.32% beats source-endpoint45.59%. Existing gradients cannot overcome a poor source/candidate class. The next concrete repair tests source/target support256, full400 train rows, actual source-weight transfer in cosine/activation/Hungarian candidates, and64x16 DAS updates. Old source64/candidate64 pilot and its source snapshots remain unchanged. Previously geometric native writes used unit weights after finite source fitting introduced fractional weights; this is an identified intervention-strength mismatch, not evidence against geometry alone.

Method progress: implement original feature-level SemanticOT top-context/centroid-shortlist/entropic-transport recipe using a batched equivalent kernel and same-objective dual fallback; implement source-gradient screening followed by direct trials under12/24/48/96 declared forward-equivalent budgets, keeping all calibration accesses explicit. Posthoc pilot screening helps at24 but not96; not confirmation or measured-time equality. The next source-only screen evaluates every original valid region on first32 train rows of23 tasks in GPT2 layer11/Pythia layer7, selecting complete-coverage sites by rawIIA/logodds/tie index. Six gss/cleft tasks and test remain unused. Independent ten-SAE training continues under the existing GPU lease; no paid resources, no other project interruption.


## FINAL_THREE_R20 PROGRESS — independent material completed

Written UTC: 2026-09-09T07:38:31Z. Verifiable training start2026-09-09T07:08:22.857996Z, complete2026-09-09T07:37:58.868860Z. Run FINAL3_R20_gpt2_independent_cohort_16m_v1_20260909 passed, contract passed, exactly16,384 updates/16,777,216tokens for each of fiveTopK and fiveMatryoshka seeds11–15. Total driver1775.9763984wall seconds and1499.921875CPU seconds; checkpoint saving31.4843seconds/quality42.3168seconds are measured nested components, not additive independent compute. RawSHA256a7e7ba4184e612ee220cfcadb08a51b56c96bf3698c2f20b2a74728b1080f0a5. PeakCUDA allocation about3.506GB, existing RTX5070Ti, no paid cost. Distinct initialization states provide another controlled cohort, conditional on the same base model, corpus/order and objective hyperparameters; no new-model or new-corpus randomness claim. The task/operation evidence is still pending. GPU released normally for the queued original-region screen; no other project lease touched.


## FINAL_THREE_R20 PROGRESS — source/consumer class repair

Written UTC: 2026-09-09T07:51:18Z. Original-region screen completed2026-09-09T07:39:24.338193Z and all source-only sites saved in r20_source_regions.json. Complete256-member pilot passed in152.8108579seconds, rawSHA548519609190dac2d0a1ebec41c80e5822fa13b7320a20ee29dacc65d7d9e190: source55.64%, nativefinite50.25%, endpoint49.75%, finite-margin50.00%, rawDAS87.25%. Joint support/train-prefix/weight-transfer changes do not close the representation-class gap. No more expansion of that weak class is justified as the main intervention. Original data and all pilot variants remain preserved. Actual source-gradient API ratio1.228 times an ordinary forward on this training batch, whereas the screening policy conservatively charges3; these are selection kernel costs, not total pipeline times.

Next concrete intervention changes the source operation, not just its member count. Fit a rank1 source DAS-style axis on source SAE reconstructed differences. It is a signed operation with coefficientsD_s^T U and source-only counterfactual supervision, explicitly no longer a native diagonal source mask. Cross-seed readers include full shared-space, completePW signed calibration, cosine mapped source atoms, natural/task ridge. Their target-only predicted request is translated by the existing actual nonnegative-decoder writer at a matched256-coordinate cap. Keep reencode, fixed donor-mask, wrong-axis, random-support, raw/full and rawDAS controls. Test3 original development tasks first before expansion; prospective pilot guard3600seconds, old examples remain development. This reuses already studied DAS and native projection algorithms; it does not make new math or semantic-identity claims. New module axis_transfer_selection.py extends the existing runtime and artifact contract. Independent Pythia/GPT2 cohort natural caches completed; full naturalPW maps continue onCPU alongside useful GPU work. Existing resources only, no purchase.


## FINAL_THREE_R20 PROGRESS — source-axis pilot and cost-aware expansion

Written UTC: 2026-09-09T07:58:32Z. Axis pilot completed2026-09-09T07:53:55.954211Z,138.695207seconds; rawSHAc157a0aba6eb253aaca149e303b90c647d74628a511fe43124e42ee2bc702eff. TopK3 tasks source80.88%, source-endpoint/base-selected native68.63%, direct finite65.69%; task-ridge native is strongest in allthree, so this is not yet evidence that endpoint selection improves over a fixed best method or base-gradient control. Reencode is substantially weaker than constrained native projection; actual matching/native/reader/source records are retained. This source-class change is more consequential than simply increasing masks.

Natural-reader score ties span distinct writers. Report uniform tie outcomes and fixed-best-candidate controls in addition to deterministic selected outputs; do not use an arbitrary tie as a manufactured superiority. Actual native writer median30.878ms/output versus ordinary forward1.825ms/sequence means LM-only budget accounting would hide a major cost. Revised screening budgets explicitly charge every candidate-vector computation, reuse precomputed prefix vectors, use sourceprefix1 and declared writer-to-forward ratio20. Cost-aware pilot at24 ties direct, at48/96 beats direct but ties cosine-screen; no cost or universal selection breakthrough is claimed.

Expanded original-task configs now cover23 development tasks at source-only selected regions, two GPT2 objectives and Pythia TopK, one1-to2 edge per condition. Expected69 queries at about35seconds plus measured SemanticOT work: roughly3000–6000GPU seconds total, per-run guard7200seconds; enlarged prospectively from the earlier3600-second stage estimate because the operation class and full matching baseline now materially differ. Existing available GPU/CPU, no paidcost or new weights. Exact same dataset/test boundaries; R21 remains the final independent confirmation/delivery round. This is one continuingR20 science block, not additional rounds.


## FINAL_THREE_R20 CORRECTION — bounded transport recovery

Written UTC: 2026-09-09T08:06:32Z. GPT2 broadv2 failed2026-09-09T08:01:22.508726Z after162.5847318seconds/151.40625CPU seconds, with zero completed task queries. Exact error: context transport source3398→target4066 marginal residual1.0576914859228292e-7 exceeded fixed1e-7. Failure, source fit, natural caches and code snapshot preserved; Pythia queue did not start after the nonzero exit. No scientific negative or confirmed result is inferred.

Targeted correction: after same-objective one-potential dual optimization, diagonal balancing preserves the entropic scaling family and refines marginals at unchanged epsilon/tolerance. Actual failed pair replay reaches1.0407589651206806e-9, recorded in R20_SEMANTIC_REFINEMENT_WITNESS.json. Sparse zero-mass fixture keeps selected atoms and costs differ by2.1e-7 against independent execution of the existing CPU kernel; this is implementation verification, not independent science. Shared float64 same-token ground distances and batched2048 transport problems remove repeated high-dimensional cost construction. Subsequentv3 runs keep all examples, candidates, objective/budget settings, and exact numerical tolerances. Row/batch progress is retained. No new protocol or research round; recover the affected baseline and continue the comprehensive work unit.


## FINAL_THREE_R20 PROGRESS — actual write 2026-09-09T08:26:47Z

round_id: FINAL_THREE_R20. Actual written_at_utc: 2026-09-09T08:26:47Z. The original23 run remains in progress; no full-suite conclusion or round completion is recorded. Completed gender/number queries reveal a concrete cross-objective failure: the Matryoshka gender source has held IIA0.7647 and shared native0.6471, while the natural-support task-ridge candidate has0.0, near-zero edit magnitude and large source-vector discrepancy. All native solves in that query satisfy the unchanged1e-4 projected-gradient criterion; this is not evidence of solver failure. Its natural-selected sparse read support discards the useful complete shared reader under task distribution shift.

The bounded response is to test a one-scalar calibration and a task-supported residual ridge correction around the existing complete reader, instead of fitting that sparse reader from zero. Exact implemented equations are in src/ccad/axis_transfer_selection.py; the old candidates and their failures remain. Config configs/final3_r20_gpt2_axis_anchored_pilot_v4.json fixes six exposed pilot queries, two objectives, original400 fitting examples and same native256 cap. Expected additional GPU workload approximately240–400seconds based on the measured35–40second query cost without SemanticOT; guard1200seconds. It will run only after the already launched GPU suite releases the shared resource. No paid or new material cost; this optional branch does not alter the running v3 snapshot.

Analysis and manuscript work now retain fixed-candidate controls, deterministic versus uniformly averaged ties, full original IIA-flip denominator and every reference method, node/task/lexical-frame sensitivities, and source-backed all-task/selection/calibration plots. Pilot export/render completed in the existing paper runtime; a clipped legend was observed and corrected. These are analysis/presentation changes, not a scientific gain. The decisive broad outcomes and the anchored-reader pilot are still required before R20 completion. Effective work time is not independently measured; no poll/wait time is counted as research.


## FINAL_THREE_R20 PROGRESS — actual write 2026-09-09T08:39:17Z

round_id: FINAL_THREE_R20. Actual written_at_utc: 2026-09-09T08:39:17Z. The bounded six-query repair pilot now also tests one concrete deployment change: compile positive/negative source-axis unit vectors into two fixed nonnegative target-code updates. For a target-only scalar coordinate alpha, use max(alpha,0)u_plus + max(-alpha,0)u_minus. This is feasible for every nonnegative recipient code; one sign uses at most256 members per input. The direction error scales exactly with abs(alpha). It tests reusable supports and lower online construction cost rather than claiming that classical nonnegative least squares is novel. Its success is unknown; all dynamic/native/re-encode/raw references remain. This candidate adds only two unit-vector solves per query and does not enlarge the planned six-query pilot or the three-round authorization.

The exact per-row re-encoding-count refit was checked against independent SciPy lsq_linear on a small numerical fixture, including zero-member rows: maximum realized difference4.66e-9. Witness artifacts/final_three_research_20260909/R20_MATCHED_PADDING_WITNESS.json. Direct selection now includes remainder-balanced allocation and successive halving; 11/14-candidate fixtures use at most the declared24/48/96 allowances and consume every recorded calibration index consistently. These correctness checks are not research findings. All changes are optional in the new pilot; the already-running original23 procedure keeps its executed source snapshot.


## FINAL_THREE_R20 PROGRESS - GPT2 complete original23 outcome

round_id: FINAL_THREE_R20. Actual written_at_utc: 2026-09-09T08:58:18Z. Event complete2026-09-09T08:56:13.147227Z. FINAL3_R20_gpt2_axis_original23_v3_20260909 passed46 queries and50048 raw metric rows, wall2975.1251989seconds/CPU2627.703125seconds, rawSHA2a5c3a34fce2d65726e51b3368364137de6170db3abd7de17a5afa78f2dcf277. Full23-task macroIIA forTopK/Matryoshka: source68.80/67.71%, unconstrained shared reader64.58/64.19%, shared native53.64/57.86%, actual reencode36.76/36.25%, rawDAS73.08% for each objective. Task-ridge native58.89/21.36% confirms the task-support/objective failure; the earlier three-taskTopK gain is not a uniform method improvement. CompletePW native30.56/30.24% and featureSemanticOT native28.26/27.94% are explicit source-axis/physical-writer adapters, not claims about the original systems' full applications.

Source endpoint chooses58.38/59.40%, direct smooth calibration58.18/59.08%; those small differences do not establish a decisive selection advantage. Posthoc development reanalysis with untouched candidates and retained calibration arrays now includes budget-remainder-balanced direct trials and direct successive halving. At budget48, source screen58.12/59.08%, balanced direct57.93/58.18%, direct halving58.70/59.02%. Thus the stronger direct comparison removes a general superiority claim. Natural score's deterministic tie gives22.25/21.74%, but uniform maxima gives37.55/38.62%; both are retained instead of exploiting the tie. Analysis paths r20_gpt2_original23_analysis and r20_gpt2_complete_budget_replay.json include source/code hashes. The single1-to2 direction is descriptive across these tasks, not independent seed-population evidence.

Pythia original23 and the bounded anchored/compiled pilot remain necessary beforeR20completion. The next intervention tests whether retaining the shared reader and compiling fixed native directions changes the actual remaining reader/write and deployment-cost gaps; it is not justified by the weak selection gap alone. Existing environment/resources only, no paid cost; elapsed commentary/analysis is not converted into invented active-research or pureGPU time.


## FINAL_THREE_R20 PROGRESS - fit the actual native consumer

round_id: FINAL_THREE_R20. Actual written_at_utc: 2026-09-09T09:12:53Z. The complete GPT2 study leaves a64.2--64.6% shared-reader versus53.6--57.9% native-writing gap despite the native Euclidean optimization. Within the already queued six-query pilot, add one bounded consumer-level repair: initialize two fixed nonnegative decoder supports from geometric compilation, then fit only their nonnegative code weights to actual source training output KL. Fixed source axis, target-only shared scalar and supports remain unchanged. At most256 coordinates are changed per input; sign-specific directions may span two dimensions. An unrestricted two-direction control receives the identical scalar,source KL, sampled64x16 updates and direction-space penalty, preserving the stronger comparison. This is supervised distillation with classic projected Adam, not a new optimizer claim.

The extra pair of fits uses6x2x64x16=12288 training sequence forward/backwards, expected tens of seconds from measured API throughput, within the existing1200-second pilot guard. Pilot config before this bounded addition is preserved atartifacts/final_three_research_20260909/r20_pilot_config_before_functional_fit.json, SHAd961206b2340a1fe1488a43db0faceae98c6388d7fb0c733437d19e3b3796a57. Official test and six reserved tasks remain unused. No new research round or paid resource. Source/target mapping changes are not selected on held outcomes. Mathematics, actual native updates, counterfactual utility and cost will be assessed together after the pilot. The old methods/results remain in the same inventory.

Reporting correction for new executions: candidate member fields now record actual nonzero code increments, separating them from the allowed support cap; oldv3 members fields represented nominal allowances. Old write arrays remain sufficient to recover actual counts and are not rewritten. This changes no v3 intervention or IIA. New compilation records also retain native replay error, cancellation, warm application timing and non-cancellation of opposite updates. These diagnostic fields do not establish semantic identity.


## FINAL_THREE_R20 PROGRESS — completed consumer repair

round_id: FINAL_THREE_R20. Actual written_at_utc: 2026-09-09T09:34:31Z. Pythia original23 completed2026-09-09T09:20:59.514916Z:23queries/25024rawrows, wall1484.073997seconds, CPU1291.5seconds, rawSHAab8fb91f98df594db3ca66ec9e2ce3b1a17e1113bb411f0fb0138c4651b7a08d. Source78.64/sharedreader76.92/sharednative61.00/reencode42.58/rawDAS82.16%; source-endpoint63.43 versus direct smooth63.62%. Across all69 developmentqueries the constrained-native improvement persists, but a general direct-selection advantage does not.

The six-query compiled pilot completed2026-09-09T09:26:53.818999Z in335.0966533wall/267.234375CPU seconds, rawSHAd9e2748f7bc02a928f8362f75a9d70bb6ca1481a5eaa0a398f491d3841b91afa. Fixed nonnegative output-fitted writes reach78.6765% macroIIA versus dynamic shared65.1961%, geometric compiled60.2941%, reencode38.2353%, source80.1471%, matched unrestricted distillation82.1078% and rawDAS87.2549%. Allsix compiled fits improve over geometric/dynamic shared, but the gap to raw references remains; three exposed tasks are development only. Scalar/residual repairs reach68.87/69.36%. Exact per-query IIA/IIA-flip/KL inr20_compiled_pilot_analysis. Mainpaper now includes the consumer repair and secondmodel with source-backed tables. No officialtest access or third-round start yet.

Unadopted optimization retained: warm-started transport dual on8 difficult existing pairs failed an initial1e-5 cost-difference assertion; diagnostic maximum7.069e-5 despite converged marginals, isolated time0.95→0.77seconds. Original cold initializer restored; no scientific choices changed. R20_TRANSPORT_WARM_START_DIAGNOSTIC.json and candidate source preserve the attempt. New steering references and hashes are registered; ordinary sandbox download first failedWinError10013, then the identical public-source read with authorized network succeeded. No installation or paid resource. Effective research time is not independently timed; no waiting is counted as research. Next: focused proof/operator and PDF review, round20 completion, then last-round freeze and independent originaltest/cohort confirmation.


## FINAL_THREE_R20 COMPLETE

round_id: FINAL_THREE_R20. Actual written_at_utc: 2026-09-09T09:40:34Z. Verifiable start2026-09-09T07:04:31Z; complete event2026-09-09T09:40:34Z. Report R20_REPORT.md/json inartifacts/final_three_research_20260909 assembled before tracker advance. Completed69-query original23 development expansion onGPT2Medium TopK/Matryoshka andPythia1B TopK; new10-SAE initialization11–15 cohort and fullPW/natural material; finite/source-axis/anchored/compiler pilots and source-matching recovery retained. Six exposed-query output-fitted fixed native result78.6765% versus shared dynamic65.1961%, geometric60.2941%, reencode38.2353%, same-information unrestricted82.1078%, rawDAS87.2549%. This is a material consumer repair but not independent confirmation or overall main-conference closure. Strong direct allocation removes a general selector-superiority conclusion.

Math, source/consumer code and closest-method comparisons now match the reported implementation. Whole20-page PDF was visually reviewed;8main/1reference/11appendix, SHAe65922426d9035ecc4659cce2b720ce136201b8893d218af92d5df089b5d62a8; exact archivearchive/research_workflow_20260909/r20_completed_manuscript_20260909T094034Z/manifest.json. Intermediate abstract model-label error corrected to actualPythia1B; original experiments were1B throughout. No undefined/Overfull warning. Prior rawruns, failures and R18package remain. Reported run wall/CPU counters are observed; attention/wait and pureGPU totals unknown, no artificial time counting. Resource status free at last check, no paid allocation or installation. R21 is the only remaining round, for frozen29-task originaltest/independentGPTinitialization/five-dependent-edge confirmation and full delivery; current execution stays in this conversation. Overall goalNOT_MET.


## FINAL_THREE_R21 START

round_id: FINAL_THREE_R21. Actual written_at_utc: 2026-09-09T09:43:22Z; verifiable start event: 2026-09-09T09:43:22Z. R20 complete and synced HEAD=origin/main55b4572 before this round. This is the third and final authorized round, not an additional budget. The positive opportunity is whether fixed nonnegative writes fitted to the actual source output preserve their development improvement on new official-test examples,6unused task types and10new GPT SAEinitializations. Method/source-site rule frozen atartifacts/final_three_research_20260909/r21_confirmation/STAGE1_PROCEDURE_FREEZE.json before any reserved source screening or officialtest download/read. Source axes and all candidates fit only originaltrain; tests are not used for tuning.

Planned actual suite:29originaltasks×5cyclic dependent edges×3model/objective conditions=435queries. GPT2Medium uses the new11–15cohort forTopK/Matryoshka; Pythia1B uses the existing1–5TopK cohort. Each edge runs separately to keep the proven2SAEs/objective memory regime. Preserve complete PW/cosine/featureSemanticOT/natural/task/anchoredreader/native/random/wrong/reencode/membermatched/fixedmask/compiledgeometric/compiledfunctional and rawDAS/unrestrictedtwo-direction references. Primary macroIIA contrasts are compiledfunctional versus dynamicshared and matched unrestricted; source validity, flip/KL/CE/cost and selection are separately reported. Primary decision comparison sourceScreen versus directhalving at48. Seed-node deletion and task/frame/node resampling cannot identify base-model/corpus populations. All29primary tasks retained;6reserved shown separately.

Existing measured runtime motivates8–13hours estimated managed workload,435queries with132evaluationrows each expected from official split metadata; perGPTedge guard21600seconds/perPythiaedge12000seconds. This is a prospective estimate, not billed or pureGPU time. Existing5070Ti/free14723MiB and free shared leases verified; expected≤8GBadditional local artifacts, no newweights/paidcost. Jobs acquire/release gpu-0 and do not stop other projects. Source-only reserved site sweep comes first, then the resolved tenconfig/code freeze, then officialtest retrieval/execution. During computation assemble mathematics, dependence analysis, reusable application/reproduction interfaces and complete manuscript/package. Finish this round with final delivery and pauseexistingautomation; do not add a fourth round. Effective work and waiting not independently timed; retain actual process clocks only.


## FINAL_THREE_R21 PROGRESS — resolved procedure frozen

round_id: FINAL_THREE_R21. Actual written_at_utc: 2026-09-09T09:46:06Z. Source-only sixreserved screen statusPASS; original source rule applied unchanged to first32train rows per task on two models. All full-coverage regions retained in screen_summary; highest rawIIA/logodds then lowest index selected, no targetSAE/test information. Exact chosen positions/evidence at r21_confirmation/reserved_source_positions.json; existing23positions unchanged. All13 source files match stage1 freeze. Ten finalconfigs saved; RESOLVED_PROCEDURE_FREEZE.json SHA2563254f8e9affb26bb719f89cc6439c1d09bb45996816c957f71c9f31d8ffa6be7 precedes test download/read, and each driver validates canonical config/code identity before loading test.json. Original400train and32dev calibrate, all original test rows evaluate; no held tuning or task filtering. Next download pinned publictest once and execute ten edge-isolated managedGPUjobs.


## FINAL_THREE_R21 PROGRESS — test execution and reusable operator

round_id: FINAL_THREE_R21. Actual written_at_utc: 2026-09-09T10:03:20Z. Resolved freezeSHA3254f8e9affb26bb719f89cc6439c1d09bb45996816c957f71c9f31d8ffa6be7 preceded test retrieval2026-09-09T09:46:13.264754–09:46:13.515992Z. Originaltest1380516bytes SHAd433abfc2b910f9cc339cc0be392a85b9f3fa4361e07e235816ade821144cdef. First run panel verifies29tasks×(400train+32cal+100test),2900originaltestindices and16nativecandidates; first few queries are running and do not determine a whole-suite conclusion. Existing managedGPU queue is unchanged; frozen13sourcefiles still match.

Reusable NumPy operator now consumes actual target recipient/donor codes and returns nonnegative increments, exact member IDs, finalselectedcodes and physicalhiddenchange. Six saved development operators each replayed on33actual naturalcodepairs, including a zero-change pair, against their verified checkpoint decoder. Maximum independentdense arithmetic error2.6645352591e-15; storedfloat32 unit-direction discrepancy≤3.1254698107e-8 and cachedphysicaldelta discrepancy≤4.9592803775e-7. CLI saved33rows successfully; totalCPU replaywall4.7715322seconds. Records r21_confirmation/compiled_operator_replay/REPLAY.json. This establishes interface arithmetic and identity, not new scientific success or a clean-machine reproduction. No GPU/LM calls were made by the replay.

Prepared condition-separated node/task/frame summaries and explicit original-task reproduction guide delivery/REPRO_FINAL3.md, including frozen-config path remapping, data/source acquisition hashes and target-only application. Added path arguments to natural retokenization helpers without changing their packing rules; old training source snapshots remain authoritative. Delivery entry versions archived before edits withmanifest. Scientific candidates and endpoints have not changed after test exposure. Current round remains2/3completed, R21running; no packaging or scientific-completion claim yet.


## FINAL_THREE_R21 PROGRESS — dependency analysis and concrete use

round_id: FINAL_THREE_R21. Actual written_at_utc: 2026-09-09T10:20:56Z. The first frozen run currently retains 16 completed queries of435 planned; the queue remains running. This progress event does not complete a new round. All13 frozen scientific source hashes still match. No candidate, endpoint, fit parameter or test-selection rule changed.

A same-machine CPU helper replay ran2026-09-09T10:12:49.456164–10:12:57.890534Z,8.434451seconds. On the six existing R20development queries, primary macro agrees with the separate saved-outcome summary; the added recurring-changed-span sensitivity preserves all four point contrasts. Its positive-multiplier intervals supplement rather than replace the frozen multinomial seed/task/frame analysis. They share actual recurring lexical spans, including names where present, but are not general entity labels or model-population confidence. New relocation freeze validates the driver's exact canonical config/code rules; cached pinned acquisition verifies files without network. NoGPU experiment or new download occurred. Artifacthelper_replay/HELPER_REPLAY.json.

Prepared source-backed edge and task-contrast figure layouts using only actual R20development rows, and a post-exposure illustration of the first officialtest example in the first frozen task/objective/edge. It retains all22 method outcomes in fixed_case.json; the displayed example illustrates execution, not representative success or confirmation. Viewed rendered layouts, corrected clipped formula and crowded preview headings. Current paper/main.pdf remains the completedR20manuscript. The selection construction-cost proxy is not measured wall-time equality, especially after compilation; final reporting must keep setup, warm vector kernel and LM execution costs separate.

The stale R18current-delivery entry was replaced after its byte archive, while the sealed15.4GBR18ZIP and historical closure receipts remain unchanged. Updated guides identify current2/3 status, pendingR21, reusable interface and public acquisition/reproduction paths. Exact new source/doc identities inr21_confirmation/DELIVERY_PREPARATION.json. Effective attention versus wait was not separately timed; no waiting is counted as research. Existing managedGPU queue continues; no paid compute, new installation or whole-project pause. Next: complete frozen ten-run suite, run the condition-separated dependency summaries, integrate all results into the unique paper, verify the full package, then recordR21COMPLETE and pause in place at the authorized limit.


## FINAL_THREE_R21 PROGRESS — hidden distance and useful output reverse

round_id: FINAL_THREE_R21. Actual written_at_utc: 2026-09-09T10:43:50Z. The frozen confirmation continues; first edge currently retains34queries of435planned. No extra round or completion count. The existing R20pilot supplies a focused test of the explanation behind output fitting: holding the source axis, target reader and both physical write supports fixed, does optimizing output fidelity improve by simply reducing hidden-space reconstruction error?

On all six exposed development queries, the saved operators have identical axes/readers/support IDs and their actual saved code increments recover the same signed scalar before and after output fitting. Error against the common requested readout rises in6/6queries, while source-output KL falls and IIA rises in6/6. Mean per-query hiddenRMSE11.91495694 to17.70901617; sourceKL0.07465535 to0.00616896; IIA60.2941% to78.6765%. These are six development cells, not six new independent experiments. The added source-training outputs can also compensate reading error, so the result establishes a proxy-objective mismatch rather than isolating anisotropy as the unique mechanism. Unrestricted matched-teacher distillation remains a separate stronger control.

Raw source:FINAL3_R20_gpt2_axis_anchored_pilot_v4_20260909, complete68held-dev rows per query, two exact operator/write NPZs per phase. Output atdevelopment_objective_comparison/SUMMARY.json andquery_metrics.csv. Analyzer written result2026-09-09T10:35:36.761689Z, observedscript wall0.231436seconds on existingCPU NumPy runtime; its exact start was not independently captured. Initial syntax error occurred before reading data, was corrected, and no experimental run was created or altered. No newGPU job, training, download or package installation.
...
### FINAL_THREE_R21 PROGRESS — first Pythia test confirms the writer gain

实际写入UTC：2026-09-09T17:29:57Z。round_id：FINAL_THREE_R21，仍2/3，未完成整轮。首Pythia run FINAL3_R21_pythia_original29_test_s1_t2_v1_20260909于2026-09-09T17:22:43.666925Z报告COMPLETE，PASS；实际driver wall2609.341249秒（43.489分钟）、process CPU2262.828125秒。保留全部29任务、每任务100原始test行、63800条22方法原始记录。raw SHA256 07a7cf95079b402c3a65764105d8169377e23f2f083978ac2f7c8ca75ac025d9已实际复算一致。只读汇总工具wall1.232833秒，主动分析/记录总时长未单独计量，未知；不把GPU运行或间隔等待计作主动研究或新增轮。

理由与结果：优先检验固定输出拟合是否把真实consumer提升延续到不同模型家族。Pythia TopK compiled IIA73.4828%，dynamic59.2759%、geometric52.8621%、shared reader71.7586%、source73.6897%；相对dynamic提高14.2069点，29任务全部改善。matched unrestricted IIA73.5862%，比compiled高0.1034点，raw DAS78.6207%高5.1379点，差距全部保留。compiled source KL0.00324100，dynamic0.10392574，matched raw0.00351782；固定native方法KL稍低而准确率稍低，不能笼统把所有端点等同。冻结前固定source-only单hook，原始29任务/全test样本；这不是官方跨所有layer的完整benchmark复刻。

选择与科学判断：source screen在24/48/96均72.9655%，未超固定73.4828%。natural screen全部预算、balanced48/96和halving24均返回固定compiled，其他balanced/halving结果完整保留。现有native菜单逐query测试最大值均值恰好等于固定73.4828%，意味着这一观测菜单内已经没有额外IIA选择空间；这是事后有限菜单事实，不是所有方法或未见总体上界。跨模型的候选写入实现收益得到一条新完整方向支持，operation-aware selector额外使用价值仍未建立。单方向及共享29任务不能支撑seed-population推断；开发期六query的幅度/方向机制不能由此次IIA提升自动得到跨模型确认，也不因此宣称概念语义同一性或一线主会核心闭合。
...
### FINAL_THREE_R21 PROGRESS — second Pythia edge repeats the complete writer gain

实际写入UTC：2026-09-09T18:12:57Z。round_id：FINAL_THREE_R21，仍2/3，未完成整轮。run FINAL3_R21_pythia_original29_test_s2_t3_v1_20260909于2026-09-09T18:06:08.160972Z报告COMPLETE，PASS；driver wall2602.577550秒、process CPU2367.234375秒。全部29任务、每任务100原始test行、63800条22方法记录保留，raw SHA256 256848c73572d9f2dd84a0a7818aa2678866bb8a666599d4e54598d0afe23eb3已实际复算一致。只读汇总工具wall2.161364秒；主动分析与记录总时长未计量，未知，不把GPU或唤醒间隔等待计作研究。

选择理由与真实结果：继续检验第二模型上固定输出拟合的优势能否跨方向保持。Pythia compiled IIA74.1724%、dynamic58.7931%、geometric52.6552%、shared reader71.8966%、source74.3448%；compiled较dynamic提高15.3793点，29任务全部改善。matched unrestricted为74.4828%，比compiled高0.3103点，raw DAS78.6207%高4.4483点。source KL compiled0.00339881、dynamic0.11395005、matched raw0.00356857；准确率负差与KL略优并列，不把端点替换为语义同一性。两个已完成Pythia方向共享seed2与29任务，不能作为两个独立重复；没有据此提前跑或改冻结的完整依赖统计。

选择价值：source和natural screen全部24/48/96预算、balanced48/96和halving24均返回固定compiled74.1724%；balanced24为69.4828%，halving48/96为71.0000/73.9310%。观测native菜单逐query测试最大值均值等于固定方法，有限候选集内没有额外IIA选择空间；这是事后观测菜单事实，不是所有方法/未见总体的上界。跨方向重复支持固定native writer的真实功能改进，selector额外价值仍未建立；原始29任务单source-only hook结果不冒充官方所有层汇总，也不自动验证六开发query的幅度/方向机制或主会核心闭合。

证据与实现：second_pythia_edge/selection_summary.json、PROGRESS_SUMMARY.json完整保留全部22方法IIA/KL、所有预算/选择计数、实际运行进度和输入hash；13个冻结源码hash复算未变。没有改候选、query、方法、阈值或预算，没有新训练/下载/安装/额外GPU作业。第三Pythia方向seed3→4于2026-09-09T18:06:13.177774Z启动，现物化349/435；准确快照second_pythia_edge/RUNTIME_SNAPSHOT.json。所有旧结果、失败和弱源保留，当前仍是同一R21工作单元。

调度和下一步：以已完成两同族run wall2609.34/2602.58秒为参考，18:11:29Z第三已运行315.99秒，预计剩余38.17分钟，操作范围35–45分钟，非置信区间。原位把ccad暂调20分钟，实际配置更新2026-09-09T18:11:33.406000+00:00，回读核对ACTIVE/原对话/prompt一致；约2026-09-09T18:31Z再估时，剩余≤20分钟恢复5分钟。旧tracker/automation逐字归档archive/research_workflow_20260909/r21_second_pythia_entry_20260909T181129Z/manifest.json。唯一paper/main.pdf22页SHA256 e2bd03af11af776f115316272e652e2fb90669d1e630af39202bae866972e53c未重复编译；七个run新结果先归同轮证据，余三个完成后统一正式确认图表/统计/全稿与最终包，留下R21 COMPLETE再计3/3并原位暂停。现有r004/RTX5070Ti及共享wrapper继续，没有新增轮数或宣称科学达标。


### FINAL_THREE_R21 PROGRESS — restore short checks for the third Pythia edge

实际写入UTC：2026-09-09T18:35:38Z。round_id：FINAL_THREE_R21，仍2/3，无新增完整科学结果或研究轮。2026-09-09T18:34:30.441506Z第三Pythia方向完成15/29、整套363/435。以先前两个Pythia同任务中位耗时为参照，当前中位比率1.04592、剩余参考985.60秒，预计剩余17.18分钟；观测比率范围对应15.59–18.31分钟，仅为调度估计，非置信区间。进度正常，满足≤20分钟恢复条件。

实际动作与下一步：automation_update原位恢复ccad每5分钟唤醒，实际配置更新2026-09-09T18:34:59.502000+00:00；回读确认ACTIVE/原对话/prompt一致。旧tracker和20分钟配置逐字归档archive/research_workflow_20260909/heartbeat_restore_20260909T183454Z/manifest.json，receipt为artifacts/final_three_research_20260909/r21_confirmation/HEARTBEAT_RESTORED_20260909T1834Z.json。仅秒级只读估时/规则状态记录，主动总时长未知，等待不计研究；未改候选、冻结源码、数据或运行进程。继续第三方向，完整后汇总并给下一run重新估时；当前稿与科学判断不因调度改变，最后三轮限额与最终交付安排保留。


### FINAL_THREE_R21 PROGRESS — third Pythia edge retains the gain and a small matched-raw reversal

实际写入UTC：2026-09-09T18:55:54Z。round_id：FINAL_THREE_R21，仍2/3，未完成整轮。run FINAL3_R21_pythia_original29_test_s3_t4_v1_20260909于2026-09-09T18:51:36.454073Z报告COMPLETE，PASS；driver wall2723.124789秒、process CPU2461.421875秒。保留29任务×100原始test行×22方法的63800行raw；SHA256 1f04354dabc31ff5fc4d0b4e2755fe3040506d957992f97fc3a00c3f1e707ede已实际复算一致。既有只读汇总工具wall2.184673秒，主动分析与记录总时长未计量，未知；GPU计算和唤醒等待不计研究轮。

理由和真实结果：继续把第二模型的固定writer增益扩展至第三方向，保留所有正负差。compiled IIA74.2069%、dynamic59.0690%、geometric53.2069%、reader71.6897%、source74.0345%；compiled较dynamic提高15.1379点，29项全部改善。matched raw IIA74.1379%，本方向compiled略高0.0690点；前两个Pythia方向compiled低于matched raw的负差仍保留，不能以这一微小逆转宣称总体超越。raw DAS为78.6207%，仍高4.4138点。source KL compiled0.00343482、dynamic0.10794127、matched raw0.00358367，compiled略低不等于语义同一性。三个Pythia方向共87项对dynamic改善，但共享SAE节点与29任务，不能作为87独立样本或三次独立seed重复。

选择结果与判断：source screen24/48为74.0345%、96等于固定74.2069%；natural所有预算与balanced96等于固定，balanced24/48为69.6552/74.0345%，halving24/48/96为74.0345/71.4138/74.0690%。现有native菜单逐query测试最大值均值仍等于固定compiled，事后有限菜单内无额外IIA选择空间；不外推到未见总体或所有可能方法。固定native操作实现的正增益持续，selector的额外使用价值仍未建立；未据此宣布主会贡献闭合。原始单source-only hook完整29任务结果不冒充官方所有层汇总；六开发query幅度/方向机制仍独立留在开发证据层。

实现、记录与资源：third_pythia_edge/selection_summary.json、PROGRESS_SUMMARY.json保留22方法IIA/KL、每个预算和选择计数、原始hash及真实运行时间；13个冻结源码hash现场核对不变。未改方法/query/候选/阈值/预算，未新增拟合、训练、下载、安装或GPU作业。第四方向seed4→5实际于2026-09-09T18:51:38.735525Z启动，当前物化377/435，精确快照third_pythia_edge/RUNTIME_SNAPSHOT.json。前三同族run wall43.49/43.38/45.39分钟，现有r004/RTX5070Ti和共享wrapper继续最后两个run，原证据全部保留。

调度与下一步：18:54:27Z第四方向已运行168.72秒，基于前三wall中位数估计剩余40.68分钟，操作范围约35–45分钟而非置信区间。原ccad暂调20分钟，实际配置更新2026-09-09T18:54:31.440000+00:00，回读确认ACTIVE/原对话/prompt一致；约2026-09-09T19:14Z复查，剩余≤20分钟恢复5分钟。旧tracker与automation逐字归档archive/research_workflow_20260909/r21_third_pythia_entry_20260909T185427Z/manifest.json。唯一paper/main.pdf22页SHA256 e2bd03af11af776f115316272e652e2fb90669d1e630af39202bae866972e53c保持当前明确标注的interim，不重复局部重建；最后两run齐备后统一正文/图表/分条件依赖统计与最终可用包，R21 COMPLETE后才计3/3并原位暂停，不新增轮次。


### FINAL_THREE_R21 PROGRESS — restore short checks for the fourth Pythia edge
